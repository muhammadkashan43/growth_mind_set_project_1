...
st.title("💽 Data Sterling Integrator by Muhammad Kashan")
st.write("This is a simple web app that allows you to upload your data and perform various operations on it.")
